import streamlit as st # Streamlit 라이브러리를 st라는 이름으로 임포트합니다.
import datetime # 날짜/시간 관련 기능은 현재 코드에서 직접 사용되지 않지만, 다른 기능 확장 시 유용합니다.
...
[cite_start]st.write("각 비디오를 시청하고 **'시청 완료 확인' 버튼**을 눌러 포인트를 획득하세요. 획득한 포인트는 안전 관련 물품 구매에 사용될 수 있습니다.") [cite: 9]
